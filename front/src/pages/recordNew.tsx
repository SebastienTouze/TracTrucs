...
export default function recordNew() {
    return (
        <Layout>
            <Head>
                <title>TracTruc - Ajouter une action</title>
            </Head>
            <main>
                <div><h2>Ajouter une action à tracer</h2></div>
                <div>
                    <form>
                        <label htmlFor="record-name">Nom de l'action</label>
                        <input id={"record-name"} type="text"/>
                        <label htmlFor={"record-objective"}>Type d'objectif
                            <input id={"record-objective-daily"} type="radio" name={"record-objective"}
                                   value={"daily"}/>
                            <label htmlFor={"record-objective"}>Objectif quotidien</label>
                            <input id={"record-objective-weekly"} type="radio" name={"record-objective"}
                                   value={"weekly"}/>
                            <label htmlFor={"record-objective"}>Objectif hebdomadaire</label>
                            <input id={"record-objective-monthly"} type="radio" name={"record-objective"}
                                   value={"monthly"}/>
                            <label htmlFor={"record-objective"}>Objectif mensuel</label>
                            <input id={"record-objective-yearly"} type="radio" name={"record-objective"}
                                   value={"yearly"}/>
